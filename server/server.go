...
// start a new server
func StartNewServer(bridgePort int, cnf *file.Tunnel, bridgeType string, bridgeDisconnect int, clientConnectTimeout int, targetConnectTimeout int, targetConnectRetryCount int, targetConnectRetryInterval int) {
	Bridge = bridge.NewTunnel(bridgePort, bridgeType, common.GetBoolByStr(beego.AppConfig.String("ip_limit")), &RunList, bridgeDisconnect, clientConnectTimeout, targetConnectTimeout, targetConnectRetryCount, targetConnectRetryInterval)
	go func() {
